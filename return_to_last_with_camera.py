...
with open('test_7_camera_and_odom_return_to_last.csv', 'ab') as csvfile:
	...
	for i in range(1,21):
		...
		# Report and log last_point
		log_and_print(i,"last_point",get_transform("origin","last_point"))

		# Return to origin (point 0)
		set_transform("odom_frame","last_point_relative",get_transform("pioneer","last_point"))
		move_base_client(get_transform("map","last_point_relative"))
		...
		set_transform("origin","last_point",get_transform("origin","pioneer"))
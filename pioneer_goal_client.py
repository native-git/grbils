...
check_camera()
add_to_tree("map","odom_guess")
add_to_tree("map","odom")
add_to_tree("odom","base_link")
(trans,rot) = t.lookupTransform("pioneer","target",rospy.Time(0))
set_transform("base_link","target_relative",trans,rot)
(goal_trans,goal_rot) = t.lookupTransform("map","target_relative",rospy.Time(0))
move_base_client(goal_trans,goal_rot)